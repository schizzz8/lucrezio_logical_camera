...
void LogicalCameraPlugin::Load(sensors::SensorPtr _sensor, sdf::ElementPtr _sdf){
    ...
    image_pub = nh->advertise<lucrezio_logical_camera::LogicalImage>("logical_camera_image", 1, true);
}

void LogicalCameraPlugin::OnUpdate(){
    msgs::LogicalCameraImage logical_image;
    lucrezio_logical_camera::LogicalImage msg;
    ...
    for(int i=0; i < number_of_models; i++){
        lucrezio_logical_camera::Model model_msg;
